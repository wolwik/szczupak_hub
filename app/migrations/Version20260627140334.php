 ...
 */
final class Version20260627140334 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, status VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, category_id INT NOT NULL, author_id INT DEFAULT NULL, best_answer_id INT DEFAULT NULL, INDEX IDX_B6F7494E12469DE2 (category_id), INDEX IDX_B6F7494EF675F31B (author_id), UNIQUE INDEX UNIQ_B6F7494EB6DEA817 (best_answer_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE question_photos (id INT AUTO_INCREMENT NOT NULL, filename VARCHAR(191) NOT NULL, question_id INT NOT NULL, UNIQUE INDEX UNIQ_F2BCFD11E27F6BF (question_id), UNIQUE INDEX uq_question_photos_filename (filename), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE answers ADD CONSTRAINT FK_50D0C6061E27F6BF FOREIGN KEY (question_id) REFERENCES question (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE question ADD CONSTRAINT FK_B6F7494EF675F31B FOREIGN KEY (author_id) REFERENCES users (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE question ADD CONSTRAINT FK_B6F7494EB6DEA817 FOREIGN KEY (best_answer_id) REFERENCES answers (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE question_photos ADD CONSTRAINT FK_F2BCFD11E27F6BF FOREIGN KEY (question_id) REFERENCES question (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE votes ADD CONSTRAINT FK_518B7ACFAA334807 FOREIGN KEY (answer_id) REFERENCES answers (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question_photos DROP FOREIGN KEY FK_F2BCFD11E27F6BF');
        ...
        $this->addSql('DROP TABLE question_photos');
